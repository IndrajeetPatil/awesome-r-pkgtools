...
- [`{styler}`](https://styler.r-lib.org) (to format code according to style guide)
...
- [`{functiondepends}`](https://cran.r-project.org/web/packages/functiondepends) (find functions in an unstructured directory and explore their dependencies)
