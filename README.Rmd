...
<div id="nb"> ⚠️⚠️  **Note Before**  ⚠️⚠️ </div>

Please change only the `README.Rmd` and/or `README.md` document, if you are not using **the latest** release of [pandoc](https://github.com/jgm/pandoc/releases).
...
- [`{altdoc}`](https://altdoc.etiennebacher.com) (use docute or docsify to create a static website for package documentation)
