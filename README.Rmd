...
- `{available}`: <https://cran.r-project.org/web/packages/available/index.html> (check if a package name is available to use)

- `{collidr}`: <https://cran.r-project.org/web/packages/collidr/> (check for namespace collisions)
...
- `{covrpage}`: <https://yonicd.github.io/covrpage/> (summary `README` of code coverage and corresponding tests)
...
- `{packageRank}`: <https://r-hub.github.io/cranlogs/> (computing CRAN download counts)
...
- `{flow}`: <https://moodymudskipper.github.io/flow/> (function logic as a flow diagram)
...
- `{TODOr}`: <https://github.com/dokato/todor> (RStudio add-in to list things that you need to do or change)
