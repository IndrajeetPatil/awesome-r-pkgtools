...
> ### Contributing
>
> If you wish to contribute to this list, please read our [Contributing
> Guidelines](CONTRIBUTING.md).
>
> **Important:** Only edit `README.qmd` - do NOT edit `README.md`,
> `README.pdf`, or `index.html` as these are automatically generated by
> our GitHub Actions workflow (on push to main, not on PRs).
...
For detailed contribution instructions, please see our [Contributing
Guidelines](CONTRIBUTING.md).
