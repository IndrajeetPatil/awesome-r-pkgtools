...
- Tools which are part of publicly archived/retired GitHub repositories
  are not included.
...
- [`{rcompendium}`](https://frbcesab.github.io/rcompendium) (to make the
  creation of R package/research compendium easier)
...
- [`{learnr}`](https://rstudio.github.io/learnr) (to turn any R Markdown
  document into an interactive tutorial)
...
- [`{lifecycle}`](https://lifecycle.r-lib.org/index.html) (to manage the
  life cycle of exported functions)
...
- [`hexwall`](https://github.com/mitchelloharawild/hexwall) (to create a
  wall of hexstickers)
...
- [`{bookdown}`](https://pkgs.rstudio.com/bookdown) (authoring framework
  for books and technical documents with R Markdown)

## Change log and versioning

- [`{fledge}`](https://cynkra.github.io/fledge/index.html) (streamlines
  the process of updating change logs and versioning R packages
  developed in git repositories)
...
- [`{autotest}`](https://docs.ropensci.org/autotest) (automatic mutation
...
- [`{mockthat}`](https://nbenn.github.io/mockthat) (function mocking for
  unit testing to third-party packages)
...
- [`{xpectr}`](https://github.com/LudvigOlsen/xpectr) (builds unit tests
  with the `{testthat}` package by providing tools for generating
  expectations)
...
- [`{precommit}`](https://lorenzwalthert.github.io/precommit) (git hooks
  for common tasks like formatting files, spell checking, etc.)
...
- [`{SimilaR}`](https://cran.r-project.org/web/packages/SimilaR/index.html)
  (quantifies the similarity of the code-base of R functions by means of
...
- [`{pkgndep}`](https://cran.r-project.org/web/packages/pkgndep) (checks
...
- [`{gpg}`](https://cran.r-project.org/web/packages/gpg/index.html) (GNU
  privacy guard for R)
...
- [`{debugr}`](https://cran.r-project.org/web/packages/debugr) (tools to
...
- [`{revdepcheck}`](https://r-lib.github.io/revdepcheck) (for automated,
...
- [`{usethat}`](https://tidylab.github.io/usethat) (to automate analytic
  project setup tasks)
