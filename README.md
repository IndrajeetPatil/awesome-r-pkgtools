...
- [`{altdoc}`](https://altdoc.etiennebacher.com) (use [docute](https://github.com/egoist/docute/) or [docsify](https://docsify.js.org/#/) to create a static website for package documentation)
