...
- <a href="#swiss-army-knives" id="toc-swiss-army-knives">Swiss army
  knives 🛠</a>
- <a href="#package-templates" id="toc-package-templates">Package
  templates 💀</a>
  - <a href="#generic" id="toc-generic">Generic</a>
  - <a href="#rmarkdown-based" id="toc-rmarkdown-based">RMarkdown-based</a>
  - <a href="#shiny" id="toc-shiny">Shiny</a>
  - <a href="#meta-packages" id="toc-meta-packages">Meta-packages</a>
- <a href="#naming-things" id="toc-naming-things">Naming things 🧸</a>
- <a href="#working-with-package-components"
  id="toc-working-with-package-components">Working with package
  components</a>
- <a href="#package-configuration" id="toc-package-configuration">Package
  configuration</a>
- <a href="#package-management-tools"
  id="toc-package-management-tools">Package management tools</a>
- <a href="#documentation" id="toc-documentation">Documentation 📚</a>
  - <a href="#manual" id="toc-manual">Manual</a>
  - <a href="#math-rendering-in-the-manual"
    id="toc-math-rendering-in-the-manual">Math rendering in the manual</a>
  - <a href="#vignettes" id="toc-vignettes">Vignettes</a>
  - <a href="#website" id="toc-website">Website</a>
  - <a href="#translation" id="toc-translation">Translation</a>
  - <a href="#lifecycle" id="toc-lifecycle">Lifecycle</a>
  - <a href="#badges-and-stickers" id="toc-badges-and-stickers">Badges and
    stickers</a>
  - <a href="#presentation" id="toc-presentation">Presentation</a>
  - <a href="#book" id="toc-book">Book</a>
  - <a href="#change-log-and-versioning"
    id="toc-change-log-and-versioning">Change log and versioning</a>
- <a href="#documentation-quality"
  id="toc-documentation-quality">Documentation quality ✒️</a>
- <a href="#unit-testing" id="toc-unit-testing">Unit testing 🧪</a>
  - <a href="#general" id="toc-general">General</a>
  - <a href="#markdown-documents" id="toc-markdown-documents">Markdown
    documents</a>
  - <a href="#shiny-applications" id="toc-shiny-applications">Shiny
    applications</a>
  - <a href="#webdatabase-applications"
    id="toc-webdatabase-applications">Web/database applications</a>
  - <a href="#visual-regression-testing"
    id="toc-visual-regression-testing">Visual regression testing</a>
  - <a href="#mock-testing" id="toc-mock-testing">Mock testing</a>
  - <a href="#helpers-for-testing-frameworks"
    id="toc-helpers-for-testing-frameworks">Helpers for testing
    frameworks</a>
- <a href="#code-formatting" id="toc-code-formatting">Code Formatting
  🧽</a>
- <a href="#code-analysis" id="toc-code-analysis">Code analysis 🗂⏱</a>
  - <a href="#general-1" id="toc-general-1">General</a>
  - <a href="#code-coverage" id="toc-code-coverage">Code coverage</a>
  - <a href="#lint-detection" id="toc-lint-detection">Lint detection</a>
  - <a href="#code-complexity" id="toc-code-complexity">Code complexity</a>
  - <a href="#code-similarity" id="toc-code-similarity">Code similarity</a>
  - <a href="#compiled-code" id="toc-compiled-code">Compiled code</a>
  - <a href="#javascript-code" id="toc-javascript-code">JavaScript code</a>
  - <a href="#lines-of-code" id="toc-lines-of-code">Lines of code</a>
- <a href="#code-performance" id="toc-code-performance">Code performance
  ⏱️</a>
  - <a href="#benchmarking" id="toc-benchmarking">Benchmarking</a>
  - <a href="#profiling" id="toc-profiling">Profiling</a>
- <a href="#dependencies" id="toc-dependencies">Dependencies ⚖️</a>
- <a href="#cran-checks-submission-and-status"
  id="toc-cran-checks-submission-and-status">CRAN checks, submission, and
  status 📬</a>
- <a href="#usage" id="toc-usage">Usage 🙈</a>
- <a href="#cicd" id="toc-cicd">CI/CD 📟</a>
- <a href="#securityprivacy" id="toc-securityprivacy">Security/Privacy
  👮</a>
- <a href="#build-systems" id="toc-build-systems">Build systems</a>
- <a href="#validation-frameworks"
  id="toc-validation-frameworks">Validation frameworks</a>
- <a href="#debugging" id="toc-debugging">Debugging 🔭</a>
- <a href="#input-validation" id="toc-input-validation">Input validation
  🔬</a>
- <a href="#package-metadata" id="toc-package-metadata">Package metadata
  🖨</a>
- <a href="#reverse-dependency-checks"
  id="toc-reverse-dependency-checks">Reverse dependency checks 📡⚰️</a>
- <a href="#gratitude" id="toc-gratitude">Gratitude 🙏💌</a>
- <a href="#docker-container" id="toc-docker-container">Docker container
  🛍</a>
- <a href="#integration-with-other-languages"
  id="toc-integration-with-other-languages">Integration with other
  languages 🔗</a>
  - <a href="#c" id="toc-c">C++</a>
  - <a href="#fortran" id="toc-fortran">Fortran</a>
  - <a href="#python" id="toc-python">Python</a>
  - <a href="#rust" id="toc-rust">Rust</a>
  - <a href="#net-framework" id="toc-net-framework">.NET Framework</a>
  - <a href="#javascripthtmlcss"
    id="toc-javascripthtmlcss">JavaScript/HTML/CSS</a>
  - <a href="#julia" id="toc-julia">Julia</a>
...
- [`{rmarkdown}`](https://rmarkdown.rstudio.com) (to convert R Markdown
  documents to a variety of formats)
...
- [`{altdoc}`](https://altdoc.etiennebacher.com) (use
  [docute](https://docute.org/) or [docsify](https://docsify.js.org/) to
  create a static website for package documentation)
...
- [`{badger}`](https://cran.r-project.org/package=badger) (query
  information and generate badges for using in `README` and
  `GitHub Pages`)
...
- [`{fledge}`](https://fledge.cynkra.com/) (streamlines the process of
...
- [`{patrick}`](https://cran.r-project.org/package=patrick) (for
  parametrized unit testing with `{testthat}`)
...
- [`{httptest}`](https://enpiar.com/r/httptest/) (a test environment for
  HTTP requests in R)

- [`{httptest2}`](https://enpiar.com/httptest2/) (the same for `{httr2}`
  package)
...
- [`{mockr}`](https://krlmlr.github.io/mockr/) (allows mocking functions
...
- [`{packageRank}`](https://cran.r-project.org/package=packageRank) (for
...
- [`{hash}`](https://cran.r-project.org/package=hash) (implements a data
  structure similar to hashes in Perl and dictionaries in Python but
  with a purposefully R flavor)
...
- [`{pkgcond}`](https://github.com/RDocTaskForce/pkgcond/) (better error
  messages for package users)
...
- [`{sessioninfo}`](https://r-lib.github.io/sessioninfo/) (to include R
  session information)
...
- [`{containerit}`](https://o2r.info/containerit/) (to package R
  script/session/workspace and all dependencies as a `Docker` container
  by generating a suitable `Dockerfile`)
