...
**Contributors:** Please direct your contributions to the [CRAN Task View](https://github.com/hturner/pkg-dev-ctv/) instead.
...
- [`{pkgkitten}`](https://eddelbuettel.github.io/pkgkitten/) (useful for creating new packages for R)
...
- [`{badgen}`](https://cran.r-project.org/package=badgen) (provides bindings to [`badgen`](https://github.com/badgen/badgen#readme) to generate beautiful 'svg' badges in R without internet access)
...
- [`{muttest}`](https://jakubsobolewski.com/muttest/) (automatic mutation testing of R packages)
...
- [`{pkgstats}`](https://docs.ropensci.org/pkgstats/) (provides metrics of R Packages)
...
- [`{flir}`](https://flir.etiennebacher.com/) (to fix lints found by `{lintr}`)
...
- [`{gha}`](https://github.com/hadley/gha) (Useful functions for GitHub Actions)
